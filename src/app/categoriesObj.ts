...
export const categoriesObj: readonly CategoriesInfo[] = [
  {
    name: 'history',
    iconSource: '/categoriesImgs/history.webp',
    anchorClassName: 'historyLink',
    textColor: 'white',
  },
  {
    name: 'geography',
    iconSource: '/categoriesImgs/geo.webp',
    anchorClassName: 'geographyLink',
    textColor: 'white',
  },
  {
    name: 'sports',
    iconSource: '/categoriesImgs/sports.webp',
    anchorClassName: 'sportsLink',
    textColor: 'white',
  },
  {
    name: 'general',
    iconSource: '/categoriesImgs/general.webp',
    anchorClassName: 'generalCatgryLink',
    textColor: 'black',
  },
  {
    name: 'food',
    iconSource: '/categoriesImgs/food.webp',
    anchorClassName: 'foodLink',
    textColor: 'white',
  },
  {
    name: 'entertainment',
    iconSource: '/categoriesImgs/entertainment.webp',
